...
- (void)viewDidLoad {
    ...
    {
        tagnum=syncType;
        manualbutton.selected=YES;
    }
    else{
        tagnum=syncType;
        automaticbutton.selected=YES;
    }
...
- (IBAction)checkboxButton:(UIButton *)button{
   ...
   /* if(button.tag==1)
    {
        [t invalidate];
        t = [NSTimer scheduledTimerWithTimeInterval:5 target:self selector:@selector(sunc1) userInfo:nil repeats:NO];
